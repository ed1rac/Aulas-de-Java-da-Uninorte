/*	Programa: EntradaComDataInputStream
	Função: Aplicativo que mostra exemplos de entrada de dados com DataInputStream
	Data: 23/05/2014 - Autor: Edkallenn - 	Observações: Java 7 - ED - p. 42
*/
import java.io.*;
